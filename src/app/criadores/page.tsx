...
export default function Criadores(){
    return(
        <main className={styles.main}>
            <Card imagem={Felipe} texto1="Felipe Rosa Peres" texto2="RM 557636" texto3="1TDSPX" Linkedin="Linkedin" Github="Github" href_Linkedin="https://www.linkedin.com/in/felipe-peres2004" href_Github="https://github.com/Felipafaa"/>
            ...
            <Card imagem={Pedro} texto1="Pedro Henrique De Souza" texto2="RM 555533" texto3="1TDSPX" Linkedin="Linkedin" Github="Github" href_Linkedin="https://www.linkedin.com/in/pedro-souza-49b728142/" href_Github="https://github.com/PedroSouza1111"/>            
        </main>
    )
}